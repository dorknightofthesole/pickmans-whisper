...
def main() -> None:
    ...
    if "NEXT_OID = 0x0000087A" not in audio:
        fail("test_audio_poc.py must expect NEXT_OID = 0x0000087A")
    ok("audio POC NEXT_OID aligned with decay-face / cloak / blade AVIF / trade headroom")
