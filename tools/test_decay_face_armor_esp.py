...
def main() -> None:
    ...
    if "NEXT_OID = 0x00000878" not in src and "NEXT_OID = 0x878" not in src:
        fail(
    ...
    if "NEXT_OID = 0x00000878" not in audio:
        fail("test_audio_poc.py must expect NEXT_OID = 0x00000878")
